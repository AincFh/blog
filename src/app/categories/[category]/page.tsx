...
const mockCategoryArticles = {
  "技术": [
    ...
    },
    {
      ...
      image: "https://picsum.photos/seed/nextjs14/800/400.jpg"
    }
  ],
  "设计": [
    {
...
export default function CategoryDetailPage() {
  ...
  const articles = mockCategoryArticles[category as keyof typeof mockCategoryArticles] || [];
  ...
  return (
    <div className="max-w-6xl mx-auto py-8 px-4">
      <div className="mb-8">
        <Link href="/categories" className="inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 mb-4 transition-colors">
