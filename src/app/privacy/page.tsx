          ...
          <div className="lg:col-span-3">
            <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    ...
                    <p>
                      在本政策中，以下术语具有以下含义�?                    </p>
                    <ul className="list-disc pl-6 space-y-2">
                      <li><strong>个人信息</strong>：以电子或者其他方式记录的能够单独或者与其他信息结合识别特定自然人身份或者反映特定自然人活动情况的各种信�?/li>
                      <li><strong>敏感个人信息</strong>：一旦泄露或者非法使用，容易导致人格尊严受到侵害或者人身、财产安全受到危害的个人信息，包括生物识别、宗教信仰、特定身份、医疗健康、金融账户、行踪轨迹等信息</li>
                      <li><strong>处理</strong>：包括个人信息的收集、存储、使用、加工、传输、提供、公开�?/li>
                      <li><strong>删除</strong>：在实现日常业务功能所涉及的系统中去除个人信息的行为，使其保持不可被检索、访问的状�?/li>
                    </ul>
                  </div>
                </div>
              )}
                ...
                <div className="space-y-6">
                  ...
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li><strong>活动信息</strong>：您参与我们组织的活动时提供的信�?/li>
                    </ul>
                    <h3 className="text-lg font-semibold mt-6 mb-3">2.2 自动收集的信�?/h3>
                    <p>
                      当您访问我们的网站时，我们可能会自动收集以下技术信息：
                    </p>
                    <ul className="list-disc pl-6 space-y-2">
                      <li><strong>设备信息</strong>：设备类型、操作系统、设备型号、屏幕分辨率、浏览器类型和版本、语言设置�?/li>
                      ...
                      <li><strong>标识�?/strong>：Cookie、类似技术收集的唯一标识符、设备标识符�?/li>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      <li><strong>社交媒体平台</strong>：当您通过社交媒体账户登录时，我们可能获取您在该平台公开的基本信�?/li>
                      <li><strong>分析服务提供�?/strong>：如Google Analytics等，用于分析网站使用情况</li>
                      <li><strong>广告服务提供�?/strong>：用于提供个性化广告内容</li>
                      <li><strong>支付处理�?/strong>：当您使用付费服务时，支付处理商可能向我们提供交易相关信�?/li>
                    </ul>
                    <h3 className="text-lg font-semibold mt-6 mb-3">2.4 收集信息的法律依�?/h3>
                    <p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li>遵守法律法规要求和执法部门请�?/li>
                    </ul>
                    <h3 className="text-lg font-semibold mt-6 mb-3">3.4 数据分析和人工智�?/h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold mt-6 mb-3">3.5 自动化决�?/h3>
                    <p>
                      我们可能使用自动化决策系统（如算法）来：
                    </p>
                    <ul className="list-disc pl-6 space-y-2">
                    ...
                    <p>
                      这些自动化决策系统可能会对您产生法律效力或类似重大影响。如果您对这些决策有异议，您有权要求人工复核�?                    </p>
                  </div>
                </div>
              )}
              ...
              {activeSection === "sharing" && (
                <div className="space-y-6">
                  ...
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    ...
                    <p>
                      您发布的内容（如文章、评论）将对其他用户公开，请谨慎分享个人信息。您可以通过账户设置控制信息的公开范围�?                    </p>
                    <h3 className="text-lg font-semibold mt-6 mb-3">4.2 服务提供�?/h3>
                    <p>
                      我们可能与以下第三方服务提供商共享必要的信息，以提供我们的服务：
                    </p>
                    <ul className="list-disc pl-6 space-y-2">
                      <li><strong>云服务提供商</strong>：如阿里云、腾讯云等，用于托管和数据存�?/li>
                      <li><strong>分析服务提供�?/strong>：如Google Analytics、百度统计等，用于网站分�?/li>
                      <li><strong>支付处理�?/strong>：如支付宝、微信支付等，用于处理付�?/li>
                      <li><strong>通信服务提供�?/strong>：如邮件服务提供商、短信服务商等，用于发送通知</li>
                      <li><strong>内容分发网络</strong>：如CDN服务商，用于加速内容加�?/li>
                      <li><strong>客服服务提供�?/strong>：用于提供客户支持服�?/li>
                    </ul>
                    <p>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      <li>法律法规要求或允�?/li>
                      <li>政府机关、司法机关或监管机构的合法请�?/li>
                      <li>保护我们的权利、财产或安全</li>
                      <li>防止欺诈、违法行为或保护他人安全</li>
                      <li>执行我们的用户协议和其他政策</li>
                    </ul>
                    <h3 className="text-lg font-semibold mt-6 mb-3">4.5 匿名化信�?/h3>
                    <p>
              ...
              {activeSection === "storage" && (
                <div className="space-y-6">
                  ...
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      <li><strong>账户信息</strong>：在您使用服务期间及之后的一定期限内（通常为账户注销�?80天）</li>
                      <li><strong>发布内容</strong>：在您删除内容或账户后的一定期限内（通常�?0-90天）</li>
                      <li><strong>日志信息</strong>：通常保留6个月�?年，用于安全分析和故障排�?/li>
                      <li><strong>交易记录</strong>：根据税务和会计要求，通常保留5-7�?/li>
                      <li><strong>法律要求</strong>：按法律法规要求的期限保�?/li>
                    </ul>
              ...
              {activeSection === "rights" && (
                <div className="space-y-6">
                  ...
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    <p>
                      根据相关法律法规，您享有以下权利�?                    </p>
                    <h3 className="text-lg font-semibold mt-6 mb-3">6.1 访问�?/h3>
                    <p>
                      您有权访问我们持有的关于您的个人信息。您可以通过账户设置查看和管理您的信息。如果您无法通过账户设置访问，您也可以联系我们获取您的个人信息副本�?                    </p>
                    <h3 className="text-lg font-semibold mt-6 mb-3">6.2 更正�?/h3>
                    <p>
                      您有权更正不准确或不完整的个人信息。您可以通过账户设置或联系我们进行更正。对于某些关键信息（如身份验证信息），我们可能要求您提供额外证明�?                    </p>
                    <h3 className="text-lg font-semibold mt-6 mb-3">6.3 删除�?/h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold mt-6 mb-3">6.4 限制处理�?/h3>
                    <p>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li>我们不再需要这些信息，但您需要它们用于法律主�?/li>
                      <li>您已反对处理，等待核实我们的合法利益是否优先</li>
                    </ul>
                    <h3 className="text-lg font-semibold mt-6 mb-3">6.5 数据可携�?/h3>
                    <p>
                      您有权以结构化、常用和机器可读的格式获取您的个人信息，并将其转移给其他控制者。您可以通过账户设置导出您的数据，或联系我们请求提供�?                    </p>
                    <h3 className="text-lg font-semibold mt-6 mb-3">6.6 反对�?/h3>
                    <p>
                      您有权反对我们基于合法利益处理您的个人信息，包括直接营销。如果您反对，我们将停止处理您的信息，除非我们有令人信服的合法理由�?                    </p>
                    <h3 className="text-lg font-semibold mt-6 mb-3">6.7 与自动化决策相关的权�?/h3>
                    <p>
                      您有权不受仅基于自动化处理（包括数据分析）的、对您产生法律效力或类似重大影响的决策的约束。您有权要求人工干预、表达您的观点和对决策提出异议�?                    </p>
                    <h3 className="text-lg font-semibold mt-6 mb-3">6.8 投诉�?/h3>
                    <p>
              ...
              {activeSection === "security" && (
                <div className="space-y-6">
                  ...
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    ...
                    <h3 className="text-lg font-semibold mt-6 mb-3">7.1 技术措�?/h3>
                    <ul className="list-disc pl-6 space-y-2">
                      <li><strong>传输安全</strong>：使用SSL/TLS加密技术保护数据传输安�?/li>
                      ...
                      <li><strong>安全评估</strong>：定期进行安全漏洞扫描和渗透测�?/li>
                      <li><strong>代码安全</strong>：安全编码规范，代码审查和静态分�?/li>
                    </ul>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li><strong>最小权�?/strong>：遵循最小权限原则，限制员工访问权限</li>
                    ...
                    <h3 className="text-lg font-semibold mt-6 mb-3">7.4 第三方安全管�?/h3>
                    <p>
              ...
              {activeSection === "international" && (
                <div className="space-y-6">
                  ...
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    ...
                    <h3 className="text-lg font-semibold mt-6 mb-3">10.3 数据本地�?/h3>
                    <p>
              ...
              {activeSection === "personalization" && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">个性化与同意管�?/h2>
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    <p>
                      您可在“设置”中开启或关闭个性化推荐，并管理用于推荐的偏好、通知与数据使用同意。我们仅在您明确同意后进行相关处理�?                    </p>
                    <ul className="list-disc pl-6 space-y-2">
              ...
              {activeSection === "contact" && (
                <div className="space-y-6">
                  ...
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    ...
                    <h3 className="text-lg font-semibold mt-6 mb-3">12.1 数据保护�?/h3>
                    <p>
