...
export default function TermsPage() {
  ...
  const sections = [
    ...
    { id: "personalization", title: "个性化推荐与数据使�? },
          ...
          <div className="lg:col-span-3">
            <div className="bg-white dark:bg-neutral-800 rounded-xl shadow-sm border border-neutral-200 dark:border-neutral-700 p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    ...
                    <p>
                      发布内容时，您声明并保证�?                    </p>
                    <ul className="list-disc pl-6 space-y-2">
                      <li>您拥有内容的全部权利或已获得必要的授�?/li>
                      <li>内容不侵犯任何第三方的知识产�?/li>
                      <li>内容不违反任何适用的法律法�?/li>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      <li>存储、托管和备份您的内容</li>
                      <li>在服务中显示和分发您的内�?/li>
                      <li>为提供和改进服务而修改您的内�?/li>
                      <li>在您删除内容后，在备份中保留内容的副�?/li>
                    </ul>
              ...
              {activeSection === "personalization" && (
                <div className="space-y-6">
                  <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">个性化推荐与数据使�?/h2>
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    <p>
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li>当启�?AI 分析时，可能使用页面片段或您选中的文本以生成建议与摘要�?/li>
                    </ul>
                    <p>
              ...
              {activeSection === "liability" && (
                <div className="space-y-6">
                  ...
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    <h3 className="text-lg font-semibold mt-6 mb-3">6.1 服务可用�?/h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold mt-6 mb-3">6.4 第三方链�?/h3>
                    <p>
              ...
              {activeSection === "miscellaneous" && (
                <div className="space-y-6">
                  ...
                  <div className="prose prose-neutral dark:prose-invert max-w-none">
                    ...
                    <h3 className="text-lg font-semibold mt-6 mb-3">8.2 可分割�?/h3>
                    <p>
                    ...
                    <h3 className="text-lg font-semibold mt-6 mb-3">8.4 不弃�?/h3>
                    <p>
